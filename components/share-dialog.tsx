        ...
        <div className="px-4 sm:px-6 pb-4 sm:pb-6 space-y-4 overflow-y-auto" style={{ maxHeight: "calc(85vh - 60px)" }}>
          ...
          <div className="flex items-center space-x-2 p-3 bg-[#2a2a2a] rounded-lg">
            ...
            <Button
              ...
              size="sm"
              className={`px-3 sm:px-4 py-1 sm:py-2 rounded-md text-sm font-medium transition-all flex-shrink-0 ${
                copied ? "bg-green-600 hover:bg-green-700 text-white" : "bg-white hover:bg-gray-100 text-black"
              }`}
            >
              {copied ? "Copied" : "Copy"}
            </Button>
